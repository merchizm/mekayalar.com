...
<section>
  ...
  {#if SOCIAL_CONNECTIONS.linkedin}
    <a href="{ 'https://linkedin.com/in/' + SOCIAL_CONNECTIONS.linkedin}">
  ...
  {#if SOCIAL_CONNECTIONS.twitter}
    <a href="{ 'https://twitter.com/' + SOCIAL_CONNECTIONS.twitter}">
      <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  {#if SOCIAL_CONNECTIONS.github}
    <a href="{'https://github.com/' +SOCIAL_CONNECTIONS.github}">
      <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        <path
