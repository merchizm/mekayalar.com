<script context="module">
  export async function load({fetch}) {
    const res = await fetch(`http://localhost/myProjects/spotify_np_api/?access_token=BQCGz6fQuPlMGqKru_vJclWTuHjIuwz-KsL4SmULpSAbFo6SAuGVR0coOJJ71ni_Mellkai8WA6Lk2mvz_k8P4hy4_Rzh40kBVwxwwPQIXClx-czGUYOyiq60TVOvUhCF5gvmFpRya9atv-f9GGPnrIv38Sz09AXfcB-2bBui7I_qMIYQVpKw5LsoHcXFIz_g0tW7jBIlZzcRg`);
    if (res.status > 400) {
      return {
        status: res.status,
...
<div>
  ...
  <div>
    ...
    <div class="font-buttons">
      <button bind:this={n_font} on:click={normalize_font}  style="display: none" aria-label="Set font size to default">
...
<style lang="scss">
  ...
  div {
    ...
    button[aria-label="Save Article"]:hover{
      svg{
        fill: #bd2c31;
      }
    }
